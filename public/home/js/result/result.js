    ...
    module.exports = {
        ...
        init: function () {
            ...
            if (url.indexOf("?") !== -1) {
                ...
                this._mid = data_id;
                $.get('../../phpCtrl/getMInfo.php?id=' + data_id, function (res) {  //get歌曲信息
                ...
                $.post('../../phpCtrl/getMInfo.php', {id: data_id}, function (res) {    //get歌词
                    var html = '';
                    if (res.length > 6) {
                        self._lrc = self._util.parseLrc(res);
                ...
                $.get('../../phpCtrl/getComment.php', {id: data_id}, function (res) {    // get 评论
                    var html = '',
                        json = $.parseJSON(res);
        ...
        bind: function () {
            ...
            $('body').on('click', '.main a.toggle', function () {
                ...
                $.get('../../phpCtrl/setComment.php', {uid: user_id, mid: self._mid, com: txt}, function (res) {
                    if (res === 'ok') {
                ...
                $.get('../../phpCtrl/setFriends.php', {mid: my_id, fid: f_id}, function (res) {
                    alert(res);
                });
            });
